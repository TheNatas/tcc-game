...
var second_level_dialogs : Array[DialogLine] = [
	...
	DialogLine.new("Suponho que já saiba que participei da construção deste avião, correto?", "Detetive Sonora", "res://assets/voice overs/voice overs full - Suponho que já saiba que particpei da construção dete avião, estou correto.wav", DETETIVE_SONORA_MINIATURE),
	...
	DialogLine.new("...Certo.", "Ministra de Armas", "res://assets/voice overs/voice overs full - ...Certo..wav", MINISTRA_ARMAS_MINIATURE),
	DialogLine.new("Conheço essa aeronave como a palma da minha mão.", "Detetive Sonora", "res://assets/voice overs/voice overs full - Ministra, eu conheço essa aeronave como a palma da minha mão.wav", DETETIVE_SONORA_MINIATURE),
	...
	DialogLine.new("Essa pergunta me ofende.", "Detetive Sonora", "res://assets/voice overs/voice overs full - essa pergunta me ofende.wav", DETETIVE_SONORA_MINIATURE),
	...
	DialogLine.new("Por favor, continue reportando os seus movimentos para que nós possamos encontrá-lo. Se continuarmos assim, até amanhã poderemos pegá-lo!", "Ministra de Armas", "res://assets/voice overs/voice overs full - Por favor, continue reportando os seus movimentos para que nós possamos encontrá-lo. .wav", MINISTRA_ARMAS_MINIATURE),
